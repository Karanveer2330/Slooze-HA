  ...
  return (
    <div>
       ...
       <div>
        ...
        <div class="checkbox">
    <input id="check" name="checkbox" type="checkbox" onClick={props.loggedin} onInput={props.onInput} />
    <label for="checkbox">
    <h4>I Agree to the <span>Accpet cookies and Terms of Service</span> and I read the Privacy Notice.</h4>
    </label>
  </div>
          <div className="buttons">
          <Link href="/Businesspg">
  <button className='btn red-btn' type="submit" name="anmelden" className="button" id="btncheck" value="Send" disabled={props.tick} >Proceed</button>
